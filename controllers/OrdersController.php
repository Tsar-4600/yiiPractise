...
class OrdersController extends Controller
{
    ...
    public function actionCancel($id){
        ...
        $model->status_order = "Отменен";
        $model->save(false);
        Yii::$app->session->setFlash('success', 'Вы успешно отменили заказ');
        return $this->redirect(['index']);
    }
    public function actionConfirm($id){
  
        $model = $this->findModel($id);
        $model->status_order = 'Подтвержен';
        $model->save(false);
        Yii::$app->session->setFlash('success', 'Вы успешно подтвердили заказ');
        return $this->redirect(['index']);
    }
}
